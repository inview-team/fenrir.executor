...
//		@Success		200
//		@Router			/{namespace}/pods/{pod_name} [delete]
func restartPod(srv *service.Executor) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			if errors.As(err, service.ErrPodNotFound) {
...
//		@Success		200
//		@Router			/{namespace}/deployments/{pod_name} [put]
func scaleDeployment(srv *service.Executor) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			if errors.As(err, service.ErrDeploymentNotFound) {
